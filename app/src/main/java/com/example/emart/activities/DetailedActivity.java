...
import com.example.emart.models.ViewAllModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (viewAllModel != null) {
            ...
            if (viewAllModel.getType().equals("egg")){
                price.setText("Price RM: " + viewAllModel.getPrice() + " /carton");
                totalPrice = viewAllModel.getPrice() * totalQuantity;
            }
            if (viewAllModel.getType().equals("milk")){
                price.setText("Price RM: " + viewAllModel.getPrice() + " /litre");
                totalPrice = viewAllModel.getPrice() * totalQuantity;
            }
            if (viewAllModel.getType().equals("product")){
                price.setText("Price RM: " + viewAllModel.getPrice() + " /item");
                totalPrice = viewAllModel.getPrice() * totalQuantity;
            }
        }
